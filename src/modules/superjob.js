            ...
            function processing(data) {
                ...
                let processingCreatedHHResume = new Promise((resolve) => {
                    ...
                    let body = {
                        ...
                        'title' : resume.name,
                        'description': null,
                        'address': resume.town !== undefined ? resume.town.title : null,
                        'trip' : resume.business_trip !== undefined ? resume.business_trip.title : null,
                        'nationality': resume.citizenship !== undefined ? resume.citizenship.title : null,
                        'schedule' : resume.type_of_work !== undefined ? resume.type_of_work.title + ' занятость' : null,
                        'phone' : phone,
                        ...
                        'education' : resume.education !== undefined ? resume.education.title + ' образование' : null,
